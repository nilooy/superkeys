                ...
                <div className="hero-content text-center">
                    <div className="max-w-md">
                        ...
                        <p className="py-6 text-2xl">
                            {dataToImport.length}{' '}
                            {dataToImport.length > 1 ? 'keys' : 'key'} imported
                            successfully
                        </p>
                    </div>
                </div>
                    ...
                    >
                        <label className="input-group">
                            ...
                            <input
                                ...
                                onChange={e =>
                                    handleDuplicateDataChange(e, item)
                                }
                                required
                            />
                        </label>
                    ...
                    <div className="alert alert-warning shadow-lg">
                        <div className="m-auto">
                            ...
                            <span className="text-center">
                                <p>
                                    These keys exists already! Keys need to be
                                    unique. You can change theme here or
                                    directly on the .json file
                                </p>
                                <p className="text-gray-800">
                                    OR click `Start Import` leaving them
                                    unchanged to update.
                                </p>
                            </span>
                        </div>
                    ...
                    <div className="alert shadow-lg mt-3">
                        <div className="m-auto">
                            ...
                            <p>
                                ...
                                Click 'Start Import' button to import{' '}
                                {dataToImport.length}{' '}
